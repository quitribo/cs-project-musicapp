...
function Controller() {
  ...
  return (
    <div className="controller">
      <button onClick={handlePlayPreviousTrack} className="buttonTest">
        <svg viewBox="0 0 24 24">
          <path d="M6 6h2v12H6zm3.5 6 8.5 6V6z"></path>
        </svg>
      </button>

      <button onClick={handleTogglePlay} className="buttonTest">
        <svg viewBox="0 0 24 24" >
          {isPlaying ? (
      ...
      <button onClick={handlePlayNextTrack} className="buttonTest">
        <svg viewBox="0 0 24 24">
